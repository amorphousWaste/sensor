...
while (True):
    ...
    temperature = dict(
        name='Temperature',
        data=air_data['T'],
        unit=air_data['T_unit'],
        icon='thermometer',
        decimals=1
    )
    illuminance = dict(
        name='Illuminance',
        data=light_data['illum_lux'],
        unit='lx',
    ...
    AQI_interpret = dict(
        ...
        data=interpret_AQI_value(air_quality_data['AQI']),
        unit='',
        icon='flower-tulip',
        decimals=0
    )
